...
public class AddProductActivity extends AppCompatActivity {
    ...
    private String productTitle,productDescription,productCategory,productQuantity,price;
    ...
    private void addProduct() {
       ...
       final String timestamp = ""+System.currentTimeMillis();
        if (image_uri==null){
            ...
            StorageReference storageReference = FirebaseStorage.getInstance("gs://instacart-fab15.appspot.com/").getReference(filePathAndName);
    ...
    private void categoryDialog() {
        ...
        builder.setTitle("Product Category")
                .setItems(Constraints.categories, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        String category = Constraints.categories[i];
